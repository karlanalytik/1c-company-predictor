...
- Para este MVP se optó por un esquema de pronósticos pre-computados offline al inicio del periodo. Este esquema permite ahorrar costos pues sólo se corre una vez al mes y al contar con los datos precalculados en la aplicación, la latencia se reduce considerablemente. 
